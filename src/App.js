      ...
      <div className="App">
        <Container>
          <Row className="justify-content-center">
            <h1 className="d-block mt-3 mt-md-5 text-center">
              Andrew Henderson
            </h1>
          </Row>
          <Row className="justify-content-center">
            <code className="d-block mb-3 mb-md-5 text-center">
              Developer • Dad • Enthusiast
            </code>
          </Row>
          <Row>
            ...
            buttonContent={[
              {
                ...
                title: "Github",
                text:
                  "Check out the source code for this site and a bit of what I have been working on lately",
                button: "Go!",
